...
- **[Nom1]** : Développement de `dataset.py` et de la boucle d'entraînement dans `train.py`.
- **[Nom2]** : Développement de `model.py`, `utils.py`, l'interface `demo.py`, et rédaction de ce rapport.
